...
public abstract class Damageable : MainMonoBehaviour, IDamageable
{
    [Header("Damageable")]
    [SerializeField] protected bool isDead;
    public bool IsDead => isDead;
    protected Vector3 senderPosition;
    ...
    public void Receiver(int damage, Vector3 _senderPosition)
    {
        this.senderPosition = _senderPosition;
